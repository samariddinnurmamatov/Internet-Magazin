...
import { apiGetSingleProduct, apiPostBasket, apiUpdateBasket } from "../../services/HomeService";
                        ...
                        <div className="top-title">
                            ...
                            <div className="icons">
                                ...
                                <div className="collapse-icons">
                                    <span className="icon icon-plus"><FaEye /></span>
                                    <span className="icon icon-plus"><IoSync /></span>
                                    <span className="icon icon-plus"><FaCartShopping /></span>
                                    <span className="icon icon-plus fav-btn"><FaRegHeart /></span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="col-lg-4">
                    <div className="info">
                        ...
                        <ul className="fsz-12 mt-15 lh-5">
                            {/* <li> <span className="icon-6 bg-666 rounded-circle me-2"></span> Intel LGA 1700 Socket: Supports 13th &amp; 12th Gen Intel Core </li> */}
                            <li> <span className="icon-6 bg-666 rounded-circle me-2"></span> {product.description_uz} </li>
                            {/* <li> <span className="icon-6 bg-666 rounded-circle me-2"></span> Commanding Power Design: Twin 16+1+2 Phases Digital VRM </li> */}
                        </ul>
                        <div className="meta pb-20">
                            <a href="#" className="meta-item color-green2"> {product.status} <span className="bg bg-green2"></span> </a>
                        </div>
                        {/* <div className="color-content">
                            <p className="color-666 mt-20"> <strong className="color-000 text-uppercase me-1"> memory size: </strong> <span> 128GB </span> </p>
                            <div className="memory-choose mt-10">
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" id="memory1" value="option1" name="memory" />
                                    <label className="form-check-label disable" >64GB</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" id="memory2" value="option2" name="memory" checked="" />
                                    <label className="form-check-label" >128GB</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" id="memory3" value="option3" name="memory" />
                                    <label className="form-check-label" >256GB</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" id="memory4" value="option4" name="memory" />
                        ...
                        {/* <div className="gift-card mb-20">
                            ...
                            <div className="gift-info">
                                <ul>
                                    <li className="fsz-14"> <i className="icon-3 bg-000 me-1"></i> Buy <span className="color-red2 fw-bold"> 02 </span> boxes get a <strong> Snack Tray </strong> </li>
                                    <li className="fsz-14"> <i className="icon-3 bg-000 me-1"></i> Buy <span className="color-red2 fw-bold"> 04 </span> boxes get a free <strong> Block Toys </strong> </li>
                                </ul>
                                <p className="fsz-12 color-666 mt-20 fst-italic"> Promotion will expires in: 9h00pm, 25/5/2024 </p>
                            </div>
                        </div> */}
                ...
                <div className="col-lg-3">
                    <div className="payment-side">
                        <div className="payment-card">
                            ...
                            <a href="#" className="butn bg-green2 text-white radius-4 fw-500 fsz-12 text-uppercase text-center mt-10 w-100 py-3" onClick={() => handleAddToBasket(product.id)}> <span> Add To Cart </span> </a>
                            {/* <a href="#" className="butn bg-orange1 color-000 radius-4 fw-500 fsz-12 text-uppercase text-center mt-10 w-100 py-3"> 
                                <span> buy with 
                                    <img src="assets/img/paypal.png" alt="" className="ms-1" />
                                </span> 
                            </a> */}
                            <div className="d-flex color-666 fsz-13 py-3 border-bottom">
                                <a href="#" className="me-4 pe-4 border-end"><FaRegHeart className="color-green2 me-1 display"/> Wishlist added </a>
                                <a href="#" className=""><FaRedoAlt className="me-1 display"/>Compare </a>
                            </div>
                        </div>
                    </div>
                </div>
