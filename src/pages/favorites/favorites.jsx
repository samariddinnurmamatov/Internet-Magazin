                                    ...
                                    { favorites.length ? favorites.map(favorite => (
                                        ...
                                        <div className="product-card" key={isToken ? favorite.id :favorite.data.id}>
                                           <div className="top-inf" style={{display: "flex", justifyContent: "space-between"}}>
                                                <small className="fsz-11 py-1 px-3 rounded-pill color-red1 "> </small>
                                                <div className="icons">
                                                <a
                                                        href="#0"
                                                        className="icon fav"
                                            ...
                                            <a href="#0" className="img">
                                                <img src={isToken ? "https://backend.elmag.uz/public/storage/"+favorite.image : favorite.data.image} alt={isToken ? favorite.name_uz :favorite.data.name_uz} className="img-contain main-image" />
                                            </a>
                                            <div className="info">
